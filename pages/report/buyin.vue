		...
		<scroll-view>
			<view class="action">
				<view class="search-box">
					...
					<text style="text-align:center; font-weight: bold">实际采购金额：¥{{realityPriceTotal}}</text>
				</view>
			...
			<view class="stock-list" :style="[{animation: 'show 0.5s 1'}]">
				<view class="stock-item" v-for="item in buyIn" :key="item.materialName">
					<view class="item-row">
					...
					<view class="item-row">
						...
						<text class="value">¥{{item.inOutSumPrice.toFixed(2) || '-' }}</text>
					</view>
