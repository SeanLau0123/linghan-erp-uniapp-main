		...
		<scroll-view>
			<view class="action">
				<view class="search-box">
					...
					<text style="text-align:center; font-weight: bold">实际销售金额：¥{{realityPriceTotal}}</text>
				</view>
			...
			<view class="stock-list" :style="[{animation: 'show 0.5s 1'}]">
				<view class="stock-item" v-for="item in saleOut" :key="item.materialId">
					<view class="item-row">
