<template>
	...
	<!-- 	    <view class="cu-item arrow animation-slide-bottom" :style="[{animationDelay: '0.1s'}]">
		    ...
		    <navigator class="cu-item arrow animation-slide-bottom" url="/pages/user/userpwedit"  :style="[{animationDelay: '0.2s'}]">
		      <view class="content">
		        <text class="cuIcon-lock text-cyan"></text>
			...
			<navigator class="cu-item arrow animation-slide-bottom" url="/pages/user/userdetail" :style="[{animationDelay: '0.6s'}]">
			     <view class="content">
					...
					<text class="text-grey">用户详情</text>
			    </view>
			</navigator>
		   <navigator class="cu-item arrow animation-slide-bottom" url="/pages/user/about" :style="[{animationDelay: '0.6s'}]">
		        <view class="content">
